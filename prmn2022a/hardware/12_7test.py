...
bus.write_byte_data(id_name['IDADDR'], REG_IODIR_A, 0x00) # 入出力レジスタAの初期化
bus.write_byte_data(id_name['IDADDR'], REG_IODIR_B, 0x00) # 入出力レジスタBの初期化
...
bus.write_byte_data(id_name['ICADDR'], REG_OLAT_B, pinSum_B) # 退出ピン(B)を全部光らせる
